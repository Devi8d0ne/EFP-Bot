...
try {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription("Connect your Discord profile to your EFP Wiki account once. Lesson results will follow your Discord profile automatically. Pass all eleven distinct lesson tests and the final assessment to enter private manager review; approval grants the gold **EFP Certified** role.")
    .addFields(
      ...
      { name: "2 • Complete training", value: "Pass each of the eleven distinct lesson tests and use **My Progress** whenever you want a private status check." },
